# -*- coding: utf-8 -*-
"""Copy of Submitted - LSDS Take Home Exam - Thirupathi.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XZ6J7aUvKmv8Yj0fnF4dhAPa_SgHnUqJ
"""
...
#       """
#       self.velocity = {} # store the momentum history for each parameter
...
#             param_updates[param_name] = self.velocity[param_name] * param_grad
...
class Optimizer:
    ...
    LEARNING_RATE = 1e-2
    MOMENTUM_COEFF = 0.9
    DECAY_RATE = 0.99  # RMSProp decay rate
    ...
    def __init__(self, params_dict: Mapping[str, np.array]):
      ...
      self.cache = {}  # store the running average of squared gradients for each parameter
      for param_name, param_values in params_dict.items():
    ...
    def step(self, param_grads: Mapping[str, np.array]) -> Mapping[str, np.array]:
        ...
        for param_name, param_grad in param_grads.items():
            ...
            # Update the parameter using the adaptive learning rate
